@{
    #Scraped from https://www.iana.org/assignments/tls-parameters/tls-parameters.xhtml
    'IanaCipherSuites' = @(
        ...
        '0x13,0x01	TLS_AES_128_GCM_SHA256	Y	Y	[RFC-ietf-tls-tls13-28]',
        '0x13,0x02	TLS_AES_256_GCM_SHA384	Y	Y	[RFC-ietf-tls-tls13-28]',
        '0x13,0x03	TLS_CHACHA20_POLY1305_SHA256	Y	Y	[RFC-ietf-tls-tls13-28]',
        '0x13,0x04	TLS_AES_128_CCM_SHA256	Y	Y	[RFC-ietf-tls-tls13-28]',
        '0x13,0x05	TLS_AES_128_CCM_8_SHA256	Y	N	[RFC-ietf-tls-tls13-28]',
        '0x13,0x06-0xFF	Unassigned			',
        '0x14-55,*	Unassigned			',
        '0x56,0x00	TLS_FALLBACK_SCSV	Y	N	[RFC7507]',
        '0x56,0x01-0xC0,0x00	Unassigned			',
        '0xC0,0x01	TLS_ECDH_ECDSA_WITH_NULL_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x02	TLS_ECDH_ECDSA_WITH_RC4_128_SHA	N	N	[RFC-ietf-tls-rfc4492bis-17][RFC6347]',
        '0xC0,0x03	TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x04	TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x05	TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x06	TLS_ECDHE_ECDSA_WITH_NULL_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x07	TLS_ECDHE_ECDSA_WITH_RC4_128_SHA	N	N	[RFC-ietf-tls-rfc4492bis-17][RFC6347]',
        '0xC0,0x08	TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x09	TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x0A	TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x0B	TLS_ECDH_RSA_WITH_NULL_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x0C	TLS_ECDH_RSA_WITH_RC4_128_SHA	N	N	[RFC-ietf-tls-rfc4492bis-17][RFC6347]',
        '0xC0,0x0D	TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x0E	TLS_ECDH_RSA_WITH_AES_128_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x0F	TLS_ECDH_RSA_WITH_AES_256_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x10	TLS_ECDHE_RSA_WITH_NULL_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x11	TLS_ECDHE_RSA_WITH_RC4_128_SHA	N	N	[RFC-ietf-tls-rfc4492bis-17][RFC6347]',
        '0xC0,0x12	TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x13	TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x14	TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x15	TLS_ECDH_anon_WITH_NULL_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x16	TLS_ECDH_anon_WITH_RC4_128_SHA	N	N	[RFC-ietf-tls-rfc4492bis-17][RFC6347]',
        '0xC0,0x17	TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x18	TLS_ECDH_anon_WITH_AES_128_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        '0xC0,0x19	TLS_ECDH_anon_WITH_AES_256_CBC_SHA	Y	N	[RFC-ietf-tls-rfc4492bis-17]',
        ...
        '0xC0,0xB0	TLS_ECCPWD_WITH_AES_128_GCM_SHA256	Y	N	[RFC-harkins-tls-dragonfly-02]',
        '0xC0,0xB1	TLS_ECCPWD_WITH_AES_256_GCM_SHA384	Y	N	[RFC-harkins-tls-dragonfly-02]',
        '0xC0,0xB2	TLS_ECCPWD_WITH_AES_128_CCM_SHA256	Y	N	[RFC-harkins-tls-dragonfly-02]',
        '0xC0,0xB3	TLS_ECCPWD_WITH_AES_256_CCM_SHA384	Y	N	[RFC-harkins-tls-dragonfly-02]',
        ...
        '0xD0,0x01	TLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256	Y	Y	[RFC-ietf-tls-ecdhe-psk-aead-05]',
        '0xD0,0x02	TLS_ECDHE_PSK_WITH_AES_256_GCM_SHA384	Y	Y	[RFC-ietf-tls-ecdhe-psk-aead-05]',
        '0xD0,0x03	TLS_ECDHE_PSK_WITH_AES_128_CCM_8_SHA256	Y	N	[RFC-ietf-tls-ecdhe-psk-aead-05]',
        '0xD0,0x04	Unassigned			',
        '0xD0,0x05	TLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256	Y	Y	[RFC-ietf-tls-ecdhe-psk-aead-05]',
        '0xD0,0x06-FF	Unassigned			',
        '0xD1-FD,*	Unassigned			',
        '0xFE,0x00-FD	Unassigned			',
        '0xFE,0xFE-FF	Reserved to avoid conflicts with widely deployed implementations			[Pasi_Eronen]',
        '0xFF,0x00-FF	Reserved for Private Use			[RFC-ietf-tls-tls13-28]'
    )
}